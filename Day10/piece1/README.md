...
`appsettings.json` holds nothing but the row count and iteration count. Copy `.env.example`
...
Full output is in `benchmark-output.txt`. I started at 5 iterations and the timings were all over
