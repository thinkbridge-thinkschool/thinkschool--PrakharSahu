...
// The ONLY thing this module knows about Jobs: the port. Not the queue, not the store,
// not the processor loop. Jobs runs this handler without ever learning quotes exist.
