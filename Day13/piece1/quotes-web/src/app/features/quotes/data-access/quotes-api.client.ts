...
export class QuotesApiClient implements QuotesFeed {
  ...
  /**
   * Angular passes error-like throwables through untouched, so this is the
   * `HttpErrorResponse` itself rather than a wrapper — see `describeHttpFailure`.
   */
  readonly failure = this.resource.error;
