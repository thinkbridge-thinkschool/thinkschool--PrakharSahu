...
public static class ResilienceEndpoints
{
    ...
    // =====================================================================================
    private static void MapFakeUpstream(IEndpointRouteBuilder app)
    {
    ...
    // =====================================================================================
    private static void MapCallers(IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/resilience");
    ...
    // =====================================================================================
    private static void MapObservability(IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/resilience");
    ...
    // being discouraged.
    // =====================================================================================
    private static void MapFaultControl(IEndpointRouteBuilder app)
    {
        // IEndpointRouteBuilder has no Environment - that is on WebApplication, and this method
        // now takes the interface so it can be mapped onto a versioned group. Resolve the
        // environment from the service provider the builder exposes instead.
        ...
        app.MapPost("/resilience/upstream/faults", (
